 ...
 * badge, and reward points. Completion is live during the match on this
 * player's phone only. After GAME_OVER, unfinished missions are marked failed.
 */
...
export function MyMissions() {
  ...
  const showLiveProgress = !isGameOver && phase !== 'LOBBY';
          ...
          return (
            ...
            >
              ...
              <div className="mt-1.5 flex items-center justify-between">
                ...
                {!mission.completed && isGameOver && (
                  <span className="text-xs font-bold text-red-400">
                    ✗ 未完成
                  </span>
                )}

                {!mission.completed && showLiveProgress && (
                  <span className="text-xs text-slate-500">
                    进行中
                  </span>
                )}
